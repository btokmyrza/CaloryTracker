...
fun GoalTypePickerScreen(
    viewModel: GoalTypePickerViewModel = hiltViewModel(),
    onNextClick: () -> Unit,
) {
    ...
    GoalTypePickerScreenContent(
        selectedGoalType = viewModel.selectedGoalType,
        onGoalTypeClick = viewModel::onGoalTypeClicked,
        onNextClick = viewModel::onNextClick,
    )
}

@Composable
private fun GoalTypePickerScreenContent(
    ...
    Box(
        ...
        Column(
            ...
            GoalTypeButtons(
                ...
                onGoalTypeClick = onGoalTypeClick,
            )
        }
        ActionButton(
...
@Composable
private fun GoalTypePickerScreenPreview() {
    CaloryTrackerTheme {
        GoalTypePickerScreenContent(
            selectedGoalType = GoalType.LoseWeight,
            onGoalTypeClick = {},
            onNextClick = {},
        )
    }
